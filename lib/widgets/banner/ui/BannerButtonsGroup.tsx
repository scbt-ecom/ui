...
export const BannerButtonsGroup = ({ buttonsConfig, classes, className }: BannerButtonsGroupProps) => {
  ...
  return (
    <div
      ...
      className={cn(
        'grid-buttons-apply desktop:static desktop:left-auto desktop:max-w-full desktop:translate-x-0 desktop:flex-row desktop:justify-normal desktop:px-0 absolute bottom-6 left-1/2 flex w-full -translate-x-1/2 flex-col justify-self-center px-4',
