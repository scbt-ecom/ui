...
export { InputSliderControl, type InputSliderControlProps } from './inputSliderControlRename'
...
export { InputControlUploader, type IInputControlUploaderProps } from './inputControlUploaderRename'
